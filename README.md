...
| Amélioration jalon 6 | Décomposition de la question **implémentée** (exigée à l'oral) — recherche hybride envisagée en secondaire, non prioritaire depuis le 5/5 | [docs/jalon6_ameliorations.md](docs/jalon6_ameliorations.md) |
